...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        {
            IResult result = BusinessRules.Run(CheckIfProductCountOfCategoruCorrect(product.CategoryId),
                CheckIfProductNameExists(product.ProductName),
                CheckIfCategoryLimitExists()
                );
            if (result != null)
            {
                return result;
        ...
        private IResult CheckIfProductCountOfCategoruCorrect(int categoryId)
        {
